...
time_now = "08:30"
db = MySQLdb.connect("localhost","root","123456","psms")
cursor = db.cursor()
...
time_range = {'since': '2017-01-18', 'until': '2017-01-18'}
...
for i in results:
    ...
    if result is not None:
        ...
        #发送邮件
        wbk = xlwt.Workbook()
        sheet = wbk.add_sheet(app_name+u"数据详情")
        ...
        for j in range(count):
            ...
            continue
        file_name = app_name+"_data.xls"
        file_dir = '/home/centos/code'
        wbk.save(file_name)
        mail_body="data"
