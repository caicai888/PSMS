...
end_date = (datetime.datetime.now()-datetime.timedelta(hours=64))-datetime.timedelta(hours=232)  #10天
...
adwords_sql = "select account_id,id from adwords where date >= '%s' and date <= '%s'" % (start_date,end_date)
